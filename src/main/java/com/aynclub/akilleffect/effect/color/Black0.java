...
public class Black0 extends MainEffectKill {

    public Black0() {
        super("black0", YAMLUtils.get("messages").getFile().exists() ? ((String) Utils.gfc("messages", "effectKill.black0.name")) : ("§cBlack0"), new ArrayList<>(Arrays.asList("&7A simple gadget...", "&7To make your kills even more entertaining!")), Heads.Blacksoup.getTexture());
    }
    ...
    public void update(User user) {
        ...
        for (int i = 0; i < particles; i++) {
            ...
            Particle.play(particleLocation, Effect.SMALL_SMOKE);
            Particle.play(locationy, Effect.SMALL_SMOKE);
        }
    }
}
