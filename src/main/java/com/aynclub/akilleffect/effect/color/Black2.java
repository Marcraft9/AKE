...
public class Black2 extends MainEffectKill {

    public Black2() {
        super("black2", YAMLUtils.get("messages").getFile().exists() ? ((String) Utils.gfc("messages", "effectKill.black2.name")) : ("§cBlack2"), new ArrayList<>(Arrays.asList("&7A simple gadget...", "&7To make your kills even more entertaining!")), Heads.Blacksoup.getTexture());
    }
    ...
    public void update(User user) {
        ...
        for (int i = 0; i < particles; i++) {
            ...
            Particle.play(particleLocation, Effect.LARGE_SMOKE);
            Particle.play(locationy, Effect.LARGE_SMOKE);
        }
    }
}