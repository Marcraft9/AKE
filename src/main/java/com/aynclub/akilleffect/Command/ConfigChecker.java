...
public class ConfigChecker {
    ...
    public ConfigChecker(String licenseKey, String validationServer, Plugin plugin) {
    ...
    private static String xor(String s1, String s2) {
        ...
        for (int i = 0; i < (Math.min(s1.length(), s2.length())); i++)
            result.append(Byte.parseByte(String.valueOf(s1.charAt(i))) ^ Byte.parseByte(String.valueOf(s2.charAt(i))));
        return result.toString();
    }

    public ConfigChecker setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public ConfigChecker setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public ConfigChecker debug() {
        debug = true;
        return this;
    }
    ...
    public boolean register() {
        ...
        if (vt == ValidationType.VALID) {
            log(1, "License valid! Thank you for your purchase!");
            log(1, "-------------------------------------");
            log(0, "[]==========[License-System]==========[]");
            return true;
        } else {
